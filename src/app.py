...
if os.environ.get("APPLICATIONINSIGHTS_CONNECTION_STRING"):
    ...
    # Instrument httpx so OpenAI SDK calls show up as dependencies in App Insights.
    # MUST run before any httpx.Client is constructed (e.g. by the OpenAI SDK).
    from opentelemetry.instrumentation.httpx import HTTPXClientInstrumentor
    HTTPXClientInstrumentor().instrument()
    print("[telemetry] HTTPXClientInstrumentor enabled", flush=True)
